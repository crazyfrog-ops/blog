...
window.addEventListener('mousemove', function(e) { gsap.to(mouseProps, {duration:1.5, x:e.clientX}); });
window.addEventListener('mousedown', function(e) { gsap.to(mouseProps, {duration:0.6, down:0.09, overwrite:true}); });
window.addEventListener('mouseup', function(e) { gsap.to(mouseProps, {duration:1, down:1, overwrite:true, ease:'none'}); });
...
img.src = 'https://s3-us-west-2.amazonaws.com/s.cdpn.io/721952/soap1.png';
img2.src = 'https://s3-us-west-2.amazonaws.com/s.cdpn.io/721952/soap2.png';
img3.src = 'https://s3-us-west-2.amazonaws.com/s.cdpn.io/721952/soap3.png';